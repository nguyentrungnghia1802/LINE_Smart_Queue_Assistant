-- =============================================================================
-- LINE Smart Queue Assistant — FULL DATABASE RESET SCRIPT
...
--
-- Run:
--   psql -U postgres -d line_queue -f reset_line_queue_schema.sql
-- =============================================================================
...
CREATE INDEX idx_orders_queue_entry_id ON orders(queue_entry_id) WHERE queue_entry_id IS NOT NULL;
...
-- Uncomment the block below if you want demo data immediately after reset.
-- =============================================================================
/*
BEGIN;

INSERT INTO organizations
  (id, name, slug, public_qr_token, logo_url, phone, address, payment_info, is_active)
VALUES
  ('11111111-1111-4111-8111-111111111111', 'Queue Lab Demo', 'queue-lab-demo', 'demo-queue-lab-2026',
   'https://example.com/logo.png', '0900000000', 'Hanoi, Vietnam',
   'Mock payment: Bank 123456789 - Queue Lab Demo', TRUE);

INSERT INTO users (id, display_name, email, phone, role, password_hash, is_active)
VALUES
  ('22222222-2222-4222-8222-222222222221', 'Alice Manager', 'alice@queue-lab.test', '0900000001', 'manager', NULL, TRUE),
  ('22222222-2222-4222-8222-222222222222', 'Bob Staff', 'bob@queue-lab.test', '0900000002', 'staff', NULL, TRUE),
  ('22222222-2222-4222-8222-222222222231', 'LINE Customer 1', NULL, '0900000031', 'customer', NULL, TRUE),
  ('22222222-2222-4222-8222-222222222232', 'LINE Customer 2', NULL, '0900000032', 'customer', NULL, TRUE),
  ('22222222-2222-4222-8222-222222222233', 'LINE Customer 3', NULL, '0900000033', 'customer', NULL, TRUE);

INSERT INTO organization_members (organization_id, user_id, role, is_active)
VALUES
  ('11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222221', 'manager', TRUE),
  ('11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222222', 'staff', TRUE);

INSERT INTO line_accounts (user_id, line_user_id, display_name, picture_url)
VALUES
  ('22222222-2222-4222-8222-222222222231', 'UdemoCustomer1', 'LINE Customer 1', NULL),
  ('22222222-2222-4222-8222-222222222232', 'UdemoCustomer2', 'LINE Customer 2', NULL),
  ('22222222-2222-4222-8222-222222222233', 'UdemoCustomer3', 'LINE Customer 3', NULL);

INSERT INTO queues
  (id, organization_id, name, description, status, queue_type, prefix, avg_service_seconds, notify_ahead_positions, auto_no_show_minutes, is_active)
VALUES
  ('33333333-3333-4333-8333-333333333331', '11111111-1111-4111-8111-111111111111',
   'Counter A', 'Main walk-in queue', 'open', 'walk_in', 'A', 900, 3, 5, TRUE);

INSERT INTO products
  (id, organization_id, name, description, product_type, price, service_time_minutes, requires_prepayment, stock_quantity, is_active)
VALUES
  ('44444444-4444-4444-8444-444444444441', '11111111-1111-4111-8111-111111111111', 'Cắt tóc nam', 'Basic haircut', 'service', 80000, 30, FALSE, NULL, TRUE),
  ('44444444-4444-4444-8444-444444444442', '11111111-1111-4111-8111-111111111111', 'Nhuộm tóc', 'Hair coloring service', 'service', 450000, 120, TRUE, NULL, TRUE),
  ('44444444-4444-4444-8444-444444444443', '11111111-1111-4111-8111-111111111111', 'Gội đầu', 'Hair wash', 'service', 50000, 20, FALSE, NULL, TRUE),
  ('44444444-4444-4444-8444-444444444444', '11111111-1111-4111-8111-111111111111', 'Trà đào', 'Peach tea', 'product', 35000, 5, FALSE, 100, TRUE),
  ('44444444-4444-4444-8444-444444444445', '11111111-1111-4111-8111-111111111111', 'Bún bò', 'Food item', 'product', 50000, 10, FALSE, 50, TRUE),
  ('44444444-4444-4444-8444-444444444446', '11111111-1111-4111-8111-111111111111', 'Khám tổng quát', 'General checkup', 'service', 200000, 45, TRUE, NULL, TRUE);
