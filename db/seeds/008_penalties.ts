...
const penalties = [
  [USERS.CUSTOMER_2, QUEUE_ENTRIES.ENTRY_7, 'no_show', 1, 'Customer did not arrive after being called'],
  [USERS.CUSTOMER_5, QUEUE_ENTRIES.ENTRY_6, 'excessive_cancel', 2, 'Customer cancelled after joining queue multiple times'],
] as const;
