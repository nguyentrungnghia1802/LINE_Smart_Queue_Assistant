...
| `deploy/scripts`                                                        | Auto-derived 12-character manual API/Web build-push with full revision metadata; backup-gated deploy wrapper and runtime-DNS rehearsal | `07`, `08`, ADR-042                           |
...
| `scripts/release`                                                       | Emergency full-SHA publisher plus immutable workflow/command-plan validation                                                           | `07`, `08`, ADR-042, ADR-043                  |
