...
| `deploy/backup`                                                         | VPS backup/verify/list/restore, tag deploy with atomic env update, metadata rollback, and rehearsal                                    | `07`, `08`, ADR-041, ADR-042                  |
| `scripts/release`                                                       | Full-SHA PowerShell API/Web publisher and dry-run command-plan validation                                                              | `07`, `08`, ADR-042                           |
| `.github/workflows/ci.yml`, `.github/workflows/deploy.yml`              | Split CI gates; manual full-SHA publication and backup-gated CD                                                                        | `07`, `08`, ADR-039, ADR-041, ADR-042         |
