...
| 14  | Media storage                | Validation/compression plus local/mock/S3-compatible adapters; production template requires S3                             | Pending provider credentials, malware scanning, retention, and CDN policy |
